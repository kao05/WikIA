...
- Conceptos clave: ¿Qué es esto? (Explicación en palabras simples de lo que se va a estudiar).

- Utilidad práctica: ¿Para qué sirve en la práctica? ¿Qué aplicaciones tiene estudiar esto?

- Relaciones: Otros conceptos o temas ligados o necesarios para entender este tema.

- Aplicaciones en la industria: ¿Dónde se incorpora este conocimiento en el mundo real?

- Roles laborales: Puestos de trabajo donde este conocimiento es indispensable.

- Reto o Proyecto: Algún problema a resolver dentro de la misma aplicación (principalmente que sea cuando tenga aplicacion de programacion) o algún proyecto que se puede llegar a realizar con este conocimiento.
